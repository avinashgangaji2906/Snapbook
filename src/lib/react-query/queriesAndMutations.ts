...
export const useSignOutAccount = () => {
  return useMutation({
    mutationFn: signOutAccount, // self called function
  });
};
...
export const useLikePost = () => {
  ...
  return useMutation({
    ...
    // once data updated(liked) it will reflect on
    //  all posts, on feed , on profile as well ....
    onSuccess: (data) => {
      queryClient.invalidateQueries({
...
export const useSavePost = () => {
  ...
  return useMutation({
    ...
    // once data updated(saved) it will reflect on
    //  all posts, on feed , on profile as well ....
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: [QUERY_KEYS.GET_RECENT_POSTS],
...
export const useGetPostById = (postId: string) => {
  return useQuery({
    ...
    enabled: !!postId, // if fetching data for same id then data will come in form
  });
};
...
export const useGetUserById = (userId: string) => {
  return useQuery({
    ...
    enabled: !!userId, // query will be enabled if user exists (truthy)
  });
};
