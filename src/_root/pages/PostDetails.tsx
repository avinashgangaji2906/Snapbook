                        ...
                        <div className="flex-between w-full">
                            ...
                            <Link to={`/profile/${post?.creator.$id}`}
                                ...
                                <div className="flex flex-col">
                                    <p className="base-medium lg:body-bolder text-light-2">{post?.creator.name}</p>
                                    <div className="flex-center gap-2 text-light-3">
                                        <p className="subtle-semibold lg:small-regular">{multiFormatDateString(post?.$createdAt)}</p>
                                        <div className="w-[5px] h-[5px] rounded-full text-light-3 bg-light-3"></div>
                            ...
                            <div className="flex-center">
                                ...
                                <Button onClick={handleDeletePost}
                                    className={`ghost_details_delete-btn ${user.id !== post?.creator.$id && "hidden"}`}
                                    variant="ghost">
                                    <img
